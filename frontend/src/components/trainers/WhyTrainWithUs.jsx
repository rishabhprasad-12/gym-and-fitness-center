          ...
          <div className="grid gap-8 md:grid-cols-2">
            {benefits.map((benefit, index) => {
              ...
              return (
                <div
                  key={benefit.title}
                  className={`group flex flex-col justify-between rounded-3xl border border-white/10 p-8 transition-all duration-300 hover:-translate-y-2 hover:border-lime-400/30
